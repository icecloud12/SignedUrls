...
use crate::{
    ...
    signed_url::{handlers::{delete_file_using_api_key, delete_file_v2},
...
pub async fn router()->axum::Router {
    ...
    let router = Router::new()
        ...
        .route(format!("{}/id/:request_id/permission/upload_v1/created/:created/expiration/:expiration/nonce/:nonce/signature/:signature",prefix).as_str(), post(process_signed_url_upload_request_v1))//Legal Alias
        .route(format!("{}/v1/id/:request_id/permission/upload_v1/created/:created/expiration/:expiration/nonce/:nonce/signature/:signature",prefix).as_str(), post(process_signed_url_upload_request_v1))
        ...
        .route(format!("{}/v2/delete/:file_id", prefix).as_str(), delete(delete_file_v2))//Formalization
		//no body limit
